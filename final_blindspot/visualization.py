...
for name_i in constants.FULL_LIST:
    ray_directions = np.load(f"{absPathRoot}/preprocessed_cache/{name_i}_directions.npy".replace("__", "_"))
    results = np.load(f"{absPathRoot}/preprocessed_cache/{name_i}_results.npy".replace("__", "_"))
    thetas = np.load(f"{absPathRoot}/preprocessed_cache/{name_i}_thetas.npy".replace("__", "_"))
    phis = np.load(f"{absPathRoot}/preprocessed_cache/{name_i}_phis.npy".replace("__", "_"))
